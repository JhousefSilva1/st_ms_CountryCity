...
//                        for country
                                ...
                                .requestMatchers(HttpMethod.PUT, "/api/country/update").permitAll()
                                .requestMatchers(HttpMethod.DELETE, "/api/country/delete").permitAll()
//                        for city
                                ...
                                .requestMatchers(HttpMethod.PUT,"/api/city/update").permitAll()
                                .requestMatchers(HttpMethod.DELETE,"/api/city/delete").permitAll()
//                        City by CountryId
...
//                        for places
                                ...
                                .requestMatchers(HttpMethod.PUT,"/api/places/update").permitAll()
                                .requestMatchers(HttpMethod.DELETE,"/api/places/delete").permitAll()
//                        for road type
                                ...
                                .requestMatchers(HttpMethod.PUT,"/api/roadType/update").permitAll()
                                .requestMatchers(HttpMethod.DELETE,"/api/roadType/delete").permitAll()
//                        for tolls
                                ...
                                .requestMatchers(HttpMethod.PUT,"/api/toll/update").permitAll()
                                .requestMatchers(HttpMethod.DELETE,"/api/toll/delete").permitAll()
